...
with app.app_context():
    ...
    pet2 = Pet(name='Charmander', species='Lizard',
               age=4, notes='Breathes fire')
    ...
    pet7 = Pet(name='Bulbasaur', species='Dinosaur',
               age=6, notes='Likes to eat')
    pet8 = Pet(name='Jigglypuff', species='Balloon',
               age=1, notes='Loves to sing')
    pet9 = Pet(name='Snorlax', species='Bear', age=7, notes='Loves to sleep')
    pet10 = Pet(name='Charizard', species='Dragon',
                age=8, notes='Breathes fire')
